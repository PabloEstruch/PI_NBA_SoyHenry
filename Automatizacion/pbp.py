...
df_play_by_play = pd.read_csv('Datos/descargados/csv/play_by_play.csv', usecols=['game_id', 'eventmsgtype', 'score', 'player1_id', 'player2_id'])

#lectura de los datos de game
df_game_info = pd.read_csv("Datos/descargados/csv/game_info.csv")
...
df.to_sql('play_by_play_py', con=engine, if_exists='replace', index=False)
